...
<form method="post" action="AddParent.php">
  ...
  <label>Select Teacher </label>
	<select name="tid">
		<?php
		$sql = mysqli_query($link, "SELECT TeacherId, FatherFirstName FROM parents");
		while ($row = $sql->fetch_assoc()){
			echo "<option value='{$row['TeacherId']}'>{$row['FatherFirstName']}</option>";
		}
		?>
	</select>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `parents`(`PupilID`, `TeacherId`, `FatherFirstName`, `FatherLastName`, `MotherFirstName`, `MotherLastName`, `Email`, `Address`, `Phone`) 
    VALUES ('$pname', '$tid', '$ffname', '$flname', '$mfname', '$mlname', '$pemail', '$padd', '$pphone')";
