...
<form method="post" action="AddPayRate.php">


  <label>Select Teacher </label>
	<select name="tid">
		<?php
		$sql = mysqli_query($link, "SELECT TeacherId, FirstName FROM teachers");
		while ($row = $sql->fetch_assoc()){
			echo "<option value='{$row['TeacherId']}'>{$row['FirstName']}</option>";
		}
		?>
	</select>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `payrate`(`TeacherId`, `TeacherName`, `BankName`, `Accountno`, `Salary`) 
    VALUES ('$tid', '$tname', '$bname', '$acno', '$sal')";
