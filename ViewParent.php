...
<h3>See all Parents</h3>
		...
		<table>
			...
			<tr>
				...
				<th width="250px">Father First Name<br><hr></th>
				<th width="250px">Father Last Name<br><hr></th>
                <th width="250px">Mother First Name<br><hr></th>
				<th width="250px">Mother Last Name<br><hr></th>
			...
			$sql = mysqli_query($link, "SELECT ParentId, PupilID, TeacherId, FatherFirstName, FatherLastName, MotherFirstName, MotherLastName, Email, Phone, Address    FROM Parents");
			...
			<tr>
				...
				<th>{$row['PupilID']}</th>
				<th>{$row['TeacherId']}</th>
				<th>{$row['FatherFirstName']}</th>
				<th>{$row['FatherLastName']}</th>
				<th>{$row['MotherFirstName']}</th>
				<th>{$row['MotherLastName']}</th>
				<th>{$row['Email']}</th>
				<th>{$row['Phone']}</th>
				<th>{$row['Address']}</th>
