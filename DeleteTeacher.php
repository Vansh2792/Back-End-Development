...
$sql = mysqli_query($link, "SELECT `TeacherId`, `FirstName`, `LastName`, `Email`, `Address`, `Phone`, `BackgroundCheck` FROM `Teachers`");
    ...
    <form method="post">
      <table>
        <tr>
          ...
          <th width="250px">Background Check</th>
...
if(isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM Teachers WHERE TeacherId IN ($teacher_ids_str)";
