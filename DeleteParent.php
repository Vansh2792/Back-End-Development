...
$sql = mysqli_query($link, "SELECT `ParentId`, `FatherFirstName`, `FatherLastName`, `MotherFirstName`, `MotherLastName`, `Email`, `Phone`, `Address` FROM `Parents` ");
...
input[type='checkbox'] {
  ...
  <div class="navbar">
    ...
    <form method="post">
      <table>
        <tr>
          <th width="150px">Parent ID</th>
          <th width="250px">Father First Name</th>
          <th width="250px">Father Last Name</th>
          <th width="250px">Mother First Name</th>
          <th width="250px">Mother Last Name</th>
        ...
        while ($row = $sql->fetch_assoc()){
          ...
          <tr>
            ...
            <td>{$row['Phone']}</td>
            <td>{$row['Address']}</td>
            <td><input type='checkbox' name='parent_ids[]' value='{$row['ParentId']}'></td>
          </tr>";
        }
        ?>
...
if(isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM Parents WHERE ParentId IN ($parent_ids_str)";
